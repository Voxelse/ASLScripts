...
init {
    ...
    vars.watchers = new MemoryWatcherList() {
        ...
        (vars.continueValue = useDeepPtr ? new MemoryWatcher<byte>(new DeepPointer((int)ptr, 0xB2)) : new MemoryWatcher<byte>(ptr+0x0)),
...
reset {
    return vars.room.Changed && vars.room.Current == 0 && vars.room.Old != 255 && vars.continueValue.Old == 0;
}
